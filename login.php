    ...
    <div class="form-container">
        <form action="" method="post" autocomplete="off" class="form-control">
            ...
            <div class="form-button-control">
                <input type="submit" value="เข้าสู่ระบบ" class="form-button form-button-1">
                <input type="reset" value="ยกเลิก" class="form-button">
            </div>
            <div class="form-footer">
                <p>หากยังไม่เป็นสมาชิก</p>
                <a href="register.php" class="form-footer-a form-a">ไปหน้าสมัครสมาชิก</a>
            </div>
        </form>
    </div>
